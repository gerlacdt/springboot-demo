...
class UserControllerIntTest(
    ...
    fun deleteTest() {
        ...
        val mvcDeleteResponse =
            this.mockMvc.perform(delete("/api/users/$id")).andExpect(status().isNoContent).andReturn()
